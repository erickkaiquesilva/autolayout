...
final class AutoLayout {
    ...
    func baseLine(
        ...
        let constraint = NSLayoutConstraint.baseLine(
            firstView: self.view,
            secondView: view,
            relation: relation,
            constant: -offSet
    ...
    func topSafeArea(
        ...
        let constraint = self.view.topAnchor.constraint(
            equalTo: aligneWith.safeAreaLayoutGuide.topAnchor,
            constant: offset
        )
        constraint.isActive = true
        constraint.priority = priority
    ...
    func bottomSafaArea(
        ...
        let constraint = self.view.bottomAnchor.constraint(
            equalTo: alignedWith.safeAreaLayoutGuide.bottomAnchor,
            constant: -offset
        )
    ...
    func leftSafeArea(
        ...
        let constraint = self.view.leftAnchor.constraint(
            equalTo: alinedWith.safeAreaLayoutGuide.leftAnchor,
            constant: offset
        )
    ...
    func rightSafeArea(
        ...
        let constraint = self.view.rightAnchor.constraint(
            equalTo: alignedWith.safeAreaLayoutGuide.rightAnchor,
            constant: -offset
        )
    ...
    func aspectRatio(
        ...
        let constraint = NSLayoutConstraint.aspectRatio(
            view: self.view,
            constant: offset
        )
    ...
    func bottomSafeArea(
        alignedWith: UIView,
        offsetForStandardLayouts offset: CGFloat
    ) {
        self.bottomSafaArea(
    ...
    func verticalCenterBetween(
        upperAnchor: NSLayoutAnchor<NSLayoutYAxisAnchor>,
    ...
    @discardableResult
    private func anchor(
        _ dimensionKeyPath: KeyPath<UIView, NSLayoutDimension>,
